<template>
 ...
 <!--  <img alt="Vue logo" src="../assets/snowyBall.png">-->
   ...
   <div  id="repulse-circle-div" class="cercle border border-white h-[300px] w-[300px] rounded-[100%] flex items-center justify-center">
    <div class="bg-white h-[95%] w-[95%] rounded-[100%] overflow-hidden">
      <img src="../assets/letter.png" class="letter scale-[5]" onmousedown="return false" onmousemove="return false" >
    </div>
   </div>

   <div class="flocons h-[34px] w-[34px] mt-8 flex justify-center relative">
     <img src="../assets/map_snow.svg" class="flocon transition duration-1000 h-[34px] absolute"  onmousedown="return false" onmousemove="return false" >
     <img src="../assets/map_snow.svg" class="flocon2 transition duration-1000 h-[34px] absolute"  onmousedown="return false" onmousemove="return false" >
   </div>
...
mounted(){
  ...
  .to('.letter', {x: 500, y: 10, duration: 1})
  ...
  tl3.to('.letter', {y:-500, duration: 0.5})
    .to('.letter', {y:500, opacity:0, duration: 0})
    .to('.letter', {y:500, opacity:1, duration: 0})
    .to('.letter', {y:0, opacity:1, duration: 0.5})
    .to('.letter', {rotate: 20, duration: 0.2})
    .to('.letter', {rotate: -15, duration: 0.2})
    .to('.letter', {rotate: 10, duration: 0.2})
    .to('.letter', {rotate: 0, duration: 0.2})
  })
  
  setTimeout(() => {
  document.querySelector(".letter").parentElement.addEventListener("mouseover", () => {
  const tl4 = gsap.timeline();
  tl4.to('.letter', {scale: "1.1", duration: 0.5})
  })

  document.querySelector(".letter").parentElement.addEventListener("mouseout", () => {
  const tl4 = gsap.timeline();
  tl4.to('.letter', {scale: "1", duration: 0.5})
  })
}, "7000");
