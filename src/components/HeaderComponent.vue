<template>
    <div class="absolute z-20 top-0 w-full left-0 py-16 px-24 max-sm:px-10 flex justify-between items-center">
        ...
        <div @click="displayMenu = !displayMenu; menuToggle()" class="hexagon w-1/4 z-50 menu-button">
        ...
        <div class="flex">
            <div>
                <div class="flex text-xs items-center">
                    <audio controls autoplay class="absolute -top-60">
    ...
    methods: {
        menuToggle: function(){
            ...
            if(this.displayMenu === false){
                ...
                menu.style.animatation="slidein 1s ease";
